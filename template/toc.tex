...
\ifnum \c@tocdepth >\m@ne
  ...
  \begingroup
    \parindent \z@ \rightskip \@pnumwidth
    \leavevmode\colorbox{darkgray}{\vtop{\hsize=\dimexpr\textwidth-2\fboxsep-7pt\relax% Additional 0.5cm padding to the right
      \hspace*{4cm}\strut\color{white}\sffamily#1% No bold, text color changed to white
      \nobreak\hfill\nobreak\hb@xt@\@pnumwidth{\hss #2}\strut}}\par
    \penalty\@highpenalty
  \endgroup
\fi}
