...
\ifnum \c@tocdepth >\m@ne
  ...
  \begingroup
    \parindent \z@ \rightskip \@pnumwidth
    \hspace*{4cm}% <- push the colorbox right
    \leavevmode\colorbox{orange}{\vtop{\hsize=\dimexpr\textwidth-2\fboxsep-4cm-7pt\relax% <- adjust the width
      \strut\color{white}\bfseries\sffamily#1 % <- remove the initial space inside the box
      \nobreak\hfill\nobreak\hb@xt@\@pnumwidth{\hss #2}\strut}}\par
    \penalty\@highpenalty
  \endgroup
\fi}
...
\ifnum \c@tocdepth >\z@
  ...
  \begingroup
    \parindent \z@ \rightskip \@pnumwidth
    \leavevmode\colorbox{black}{\vtop{\hsize=\dimexpr\textwidth-2\fboxsep-7pt\relax
...
\ifnum \c@tocdepth >1
  ...
  \begingroup
    \parindent \z@ \rightskip \@pnumwidth
    \leavevmode\colorbox{gray!40}{\vtop{\hsize=\dimexpr\textwidth-2\fboxsep-7pt\relax
      \hspace*{4cm}\strut\color{white}\sffamily#1
      \nobreak\hfill\nobreak\hb@xt@\@pnumwidth{\hss #2}\strut}}\par
    \penalty\@highpenalty
  \endgroup
