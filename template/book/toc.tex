...
\hypersetup{hidelinks,backref=true,pagebackref=true,hyperindex=true,colorlinks=true,breaklinks=true,urlcolor=fgacc,bookmarks=true,bookmarksopen=false,pdftitle={\TITLE},pdfauthor={\AUTHOR},pdfsubject={\SUBJECT}}
\@starttoc{toc}
}
...
\ifnum \c@tocdepth >-2
  ...
  \begingroup
    ...
    \leavevmode\colorbox{fgacc}{\vtop{\hsize=\dimexpr\textwidth\relax
      \strut\color{fg}\bfseries\sffamily\uppercase{#1}%
