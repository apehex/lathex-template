...
\ifnum \c@tocdepth >-2
  ...
  \begingroup
    ...
    \leavevmode\colorbox{orange}{\vtop{\hsize=\dimexpr\textwidth\relax
...
\ifnum \c@tocdepth >\m@ne
  ...
  \begingroup
    \parindent \z@ \rightskip \@pnumwidth
    \leavevmode\colorbox{darkgray}{\vtop{\hsize=\dimexpr\textwidth\relax
...
\ifnum \c@tocdepth >1
  ...
  \begingroup
    \parindent \z@ \rightskip \@pnumwidth
    \leavevmode\colorbox{gray!40}{\vtop{\hsize=\dimexpr\textwidth\relax
      \hspace*{4cm}\strut\color{white}\sffamily#1
      \nobreak\hfill\nobreak\hb@xt@\@pnumwidth{\hss #2}\strut}}\par
    \penalty\@highpenalty
  \endgroup
