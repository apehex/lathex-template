...
\newcommand{\sectiontitletext}[2][accent]{%
    \textcolor{#1}{\MakeUppercase{\textbf{#2}}}% \small
}

% HORIZONTAL %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\newenvironment{horizontalsection}[2][accent]{%
    \par\vspace{\sectionmargin}%
    \sectiontitletext[#1]{#2}
    \hspace{6pt}%
...
\newenvironment{verticalsection}[2][accent]{%
    \par\vspace{\sectionmargin}%
    % Store the whole box with the vertical title
    \sbox{\sectiontitlebox}{\rotatebox{90}{\sectiontitletext[#1]{#2}}}%
