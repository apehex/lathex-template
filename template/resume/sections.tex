...
\newenvironment{verticalsection*}[3]{% title text, title color, rule color
    % stash args for the end block
    \def\verticalsectiontitletext{#1}%
    \def\verticalsectiontitlecolor{#2}%
    \def\verticalsectionrulecolor{#3}%
    % reset the position
    \par\noindent%
